...
sim_move_positions = {
    ...
    "loading_position":     [5.7, 0.0, -1.7],  # 5.8 -1.57
    "shipping_position":    [2.4, 1.4, 1.37]    # 1.57
}

real_move_positions = {
    "init_position":        [0.018, 0.005, 0.0], # 0.018 0.005 -0.304
...
def main(argv, args):
    ...
    robot_utils = RobotUtilsNode(args.target)
    ...
    if result == TaskResult.SUCCEEDED:
        ...
        robot_utils.angular_vel = 0.05

        if robot_utils.target_env_ == 'real':
            robot_utils.move_robot_cnt = 15
        else:
